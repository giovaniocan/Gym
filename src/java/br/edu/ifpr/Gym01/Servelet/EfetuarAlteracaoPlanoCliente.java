 ...
 * @author giovani
 */
@WebServlet(name = "EfetuarAlteracaoPlanoCliente", urlPatterns = {"/EfetuarAlteracaoPlanoCliente"})
public class EfetuarAlteracaoPlanoCliente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            for (Cookie cookie : cookies) {
                try {
                    ...
                    int id = u.getId();
                    model.alterarPlano(u, idPlano);
                } catch (SQLException ex) {
                    Logger.getLogger(EfetuarAlteracaoPlanoCliente.class.getName()).log(Level.SEVERE, null, ex);
                }
