...
@WebFilter(filterName = "FilterUsuario",
        servletNames = { "MenuCliente", "CadastroPlanoCliente", "EfetuarCadastroPlanoCliente", "EfetuarAlteracaoPlanoCliente","ALterarPlanoCliente", "EditarPerfil" })
